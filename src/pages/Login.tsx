  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Successfully logged in to StoreManager Pro",
      });
      navigate("/dashboard");
      ...
      <div className="w-full max-w-md p-4 z-10 relative">
        ...
        >
          <CardHeader className="space-y-1 flex flex-col items-center pb-2">
            ...
            <CardTitle className="text-3xl font-bold text-center bg-gradient-to-br from-store-800 to-store-600 bg-clip-text text-transparent">
              StoreManager Pro
            </CardTitle>
            <CardDescription className="text-center text-muted-foreground font-medium">
              Enter your credentials to manage your general store
            </CardDescription>
          </CardHeader>
          <form onSubmit={handleLogin}>
            ...
            <CardFooter className="flex flex-col space-y-4 pt-2">
              <Button
                type="submit"
                className="btn-store w-full font-medium text-base"
                disabled={isLoading}
              >
                {isLoading ? (
              ...
              <p className="text-sm text-center text-muted-foreground">
                ...
                <Link to="/register" className="font-semibold text-store-600 hover:text-store-700 hover:underline transition-all focus-ring rounded">
                  Create an account
                </Link>
              </p>
            </CardFooter>
